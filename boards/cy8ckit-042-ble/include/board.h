...
/**
 * @defgroup    board_cy8ckit-042-ble Cypress PSoC 4 BLE development kit
 * @ingroup     boards
 * @brief       Support for the CY8CKIT-042-BLE PSoC 4 BLE board
 * @{
 *
 * @file
 * @brief       Board specific definitions for the cy8ckit-042-ble board
 *
